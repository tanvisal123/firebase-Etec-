...
class _ProductEditPageState extends State<ProductEditPage> {
  ...
  late var _priceCtrl = TextEditingController(text: widget.item.price.toString());
  ...
  late var _qtyCtrl = TextEditingController(text: widget.item.qty.toString());
    ...
    return ElevatedButton(
      onPressed: () async {
        if (_formKey.currentState!.validate()) {
          widget.item.name = _nameCtrl.text.trim();
          widget.item.price = num.parse(_priceCtrl.text.trim());
          widget.item.qty = num.parse(_qtyCtrl.text.trim());
          widget.item.image = _imageCtrl.text.trim();

          await ProductHelper.updateRecord(widget.item);
  ...
  Widget _buildDeleteButton() {
    return ElevatedButton(
      ...
      onPressed: () async {
        await ProductHelper.deleteRecord(widget.item);
        Navigator.of(context).pop();
      },
      child: Text("DELETE"),
    );
